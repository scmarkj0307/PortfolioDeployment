            ...
            <div className="homeContainer" id='home'>
                <div className="c-1">
                    <div className="myTechStack">
                        ...
                        <h2><Typewriter
                                options={{
                                strings: [" REACT JS", " REACT NATIVE", " JAVASCRIPT" , "NODE JS" , "EXPRESS" , " SPRINGBOOT", "NO SQL AND SQL", "CSS AND STYLEX", "TAILWIND CSS"],
                                autoStart: true,
                                loop: true,
                                }}
                        /></h2>
                ...
                <div className="c-2">
                    <div className="typingGreetings">
                      <p>HI!! Good day, Im <span style={{color: 'cyan'}}> Arnaiz, Jhonmark R. </span> An aspiring web and mobile developer</p>
                    </div>
                </div>
